...
class CompromiseRSSTEvidenceQuery implements ICompromiseRSSTEvidenceQuery
{
    private $name = 'name';
    private $file = 'file';
    private $type = 'type';
    ...
    public function index(Request $request){
        try {
            $evidences = CompromiseRSSTEvidence::select(['id', 'file', 'approved', 'compromise_id'])
    ...
    public function store(Request $request){
        ...
        try {
            ...
            $evidence = new CompromiseRSSTEvidence();             
    ...
    public function update(Request $request, int $id)
    {
        if ($id) {
            try {
                $evidence = CompromiseRSSTEvidence::findOrFail($id);
    ...
    public function showByCompromiseEvidenceId(Request $request, int $id){
        ...
        if ($id) {
            try {
                $evidence = CompromiseRSSTEvidence::select(
                    'id',
                    'name',
                    'file',
                    'type',
