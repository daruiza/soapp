...
use App\Model\Core\CompromiseSSTEvidence;
...
class CompromiseSSTEvidenceQuery implements ICompromiseSSTEvidenceQuery
{
    private $name = 'name';
    private $file = 'file';
    private $type = 'type';
    ...
    public function index(Request $request){
        try {
            $evidences = CompromiseSSTEvidence::select(['id', 'file', 'approved', 'compromise_id'])
    ...
    public function store(Request $request){
        ...
        try {
            ...
            $evidence = new CompromiseSSTEvidence();             
    ...
    public function update(Request $request, int $id)
    {
        if ($id) {
            try {
                $evidence = CompromiseSSTEvidence::findOrFail($id);
    ...
    public function showByCompromiseEvidenceId(Request $request, int $id){
        ...
        if ($id) {
            try {
                $evidence = CompromiseSSTEvidence::select(
                    'id',
                    'name',
                    'file',
                    'type',
